...
#include "AMealeStrike.generated.h"

UCLASS()
class APROJECT_API AAMealeStrike : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	UFUNCTION(BlueprintCallable)
	void BeginOverlapSphere(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult);
	...
	UFUNCTION(BlueprintCallable)
	void BeginOverlapBox(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult);
